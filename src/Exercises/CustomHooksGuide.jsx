...
import { customHooksData } from "../data/customHooksData";
...
const CustomHooksGuide = () => {
  const guide = customHooksData[0];
...
useEffect(() => {
  const saved = localStorage.getItem("CustomHooksGuideCheckedTitles");
  if (saved) {
          ...
          <article>
            <section className='hero-section'>
              <h1 className='title'>
                ...
                <span className='title-sub'>A Complete Beginner's Guide</span>
              </h1>
              <img
                className='top-image'
                src={guide.image}
