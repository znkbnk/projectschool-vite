...
import { componentsPropsData } from "../data/componentsPropsData";
import Navbar from "../components/Navbar";
import Footer from "../components/Footer";
import "../styles/usestateGuide.css";
import SyntaxHighlighter from "react-syntax-highlighter";
import PropTypes from "prop-types";
// import StateEffectLearningJourneySection from "./StateEffectLearningJourneySection";
...
// Don't link useState or useEffect on the combined guide page
const EXCLUDE = [
...
const ComponentsPropsGuide = () => {
  const guide = componentsPropsData[0];
  ...
  useEffect(() => {
    const saved = localStorage.getItem("componentsPropsCheckedTitles");
    if (saved) {
      ...
      <main className='main'>
        <div className='guide'>
          <article>
            ...
            {/* Features Grid */}
            {/* <StateEffectLearningJourneySection /> */}
            {showBackToTop && (
              <button
...
export default ComponentsPropsGuide;
