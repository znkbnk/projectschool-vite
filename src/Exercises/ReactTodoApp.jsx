...
import { reactTodoAppData } from "../data/reactTodoAppData";
...
const ReactTodoApp = () => {
  const guide = reactTodoAppData[0];
  ...
  const saved = localStorage.getItem("reactTodoAppCheckedTitles");
