const usestateData = [
  {
    id: "react-usestate-guide",
    title: "The Definitive Guide to Mastering the React useState Hook",
    image: "/images/usestateLogo.webp",
    paragraphs: [
      {
        type: "text",
        content:
      ...
      {
        type: "title",
        content: "Understanding useState Hook",
      },
      {
        type: "text",
        content:
...
function MyComponent() {
  ...
  // initialValue: starting value (number, string, boolean, object, array, or function)
      ...
      {
        type: "boldText",
        content: "The Five Rules of useState",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "code",
        content: `// Bad: runs on EVERY render
...
const [data, setData] = useState(() => expensiveComputation());`,
      ...
      {
        type: "boldText",
        content: "1. Mutating State Directly",
      },
      {
        type: "code",
        content: `// WRONG: Same reference — React won't re-render
...
setUser({ ...user, age: 26 });`,
      ...
      {
        type: "boldText",
        content: "2. Stale Closures in Rapid Updates",
      },
      {
        type: "code",
        content: `// WRONG: All three read the same stale 'count' value
...
const handleTripleIncrement = () => {
  ...
  setCount(prev => prev + 1);  // 2 → 3
      ...
      {
        type: "boldText",
        content: "4. Object State vs Multiple States",
      },
      {
        type: "code",
        content: `// Option A: Related fields in one object
...
// Split fields that change independently.`,
      ...
      {
        type: "title",
        content: "Example 1: The Classic Counter",
      },
      {
        type: "text",
        content:
  ...
  return (
    <div>
      ...
      },
      {
        ...
        hint: "Hint: You need two states — one for count and one for step. The Add button calls setCount(count + step).",
...
export default StepCounter;`,
      },
      {
        ...
        hint: "Hint: Store a colour string in state. Each button calls setColor with its colour.",
        solution: `import { useState } from 'react';
...
export default ColorChanger;`,
      },
      {
        ...
        hint: "Hint: Use useState('') for the name. The input's onChange updates state with e.target.value.",
        solution: `import { useState } from 'react';
...
export default NameGreeting;`,
      ...
      // ═══════════════════════════════════════════
      // EXAMPLE 2: TOGGLE (BOOLEANS)
      // ═══════════════════════════════════════════
      {
        type: "title",
        content: "Example 2: Toggle Switch — Mastering Booleans",
      },
      {
        type: "text",
        content:
  ...
  return (
    <div style={{
      ...
      },
      {
        ...
        hint: "Hint: useState(false) where false = light mode. Apply conditional styles to a wrapper div.",
        solution: `import { useState } from 'react';
...
export default ThemeToggle;`,
      },
      {
        ...
        hint: "Hint: useState(false) for showPassword. The input's type is showPassword ? 'text' : 'password'.",
        solution: `import { useState } from 'react';
...
export default PasswordToggle;`,
      },
      {
        ...
        hint: "Hint: useState(false) for isOpen. Render the answer only when isOpen is true: {isOpen && <p>Answer</p>}.",
        solution: `import { useState } from 'react';
...
export default Accordion;`,
      ...
      // ═══════════════════════════════════════════
      // EXAMPLE 3: FORM WITH VALIDATION (OBJECTS)
      // ═══════════════════════════════════════════
      {
        type: "title",
        content: "Example 3: Signup Form with Validation — Object State",
      },
      {
        type: "text",
        content:
  ...
  return (
    <div>
      ...
      },
      {
        ...
        hint: "Hint: The character counter is message.length — a derived value, not separate state.",
        solution: `import { useState } from 'react';
...
export default ContactForm;`,
      },
      {
        ...
        hint: "Hint: The preview just reads from form state — no separate state needed.",
        solution: `import { useState } from 'react';
...
export default ProfileEditor;`,
      ...
      // ═══════════════════════════════════════════
      // EXAMPLE 4: TODO LIST (ARRAYS)
      // ═══════════════════════════════════════════
      {
        type: "title",
        content: "Example 4: To-Do List with Filters — Array State",
      },
      {
        type: "text",
        content:
  ...
  return (
    <div>
      ...
      },
      {
        ...
        hint: "Hint: Each item is { id, name, quantity }. Total is items.reduce((sum, i) => sum + i.quantity, 0).",
        solution: `import { useState } from 'react';
...
export default ShoppingList;`,
      },
      {
        ...
        hint: "Hint: Each message has reactions: { like: 0, love: 0, laugh: 0 }. Update with nested spread: { ...msg, reactions: { ...msg.reactions, [emoji]: count + 1 } }.",
        solution: `import { useState } from 'react';
...
export default EmojiTracker;`,
      },
      {
        ...
        hint: "Hint: All tasks in one array with a status field. Filter by status per column. Move = map to update the status.",
        solution: `import { useState } from 'react';
...
export default KanbanBoard;`,
      ...
      // ═══════════════════════════════════════════
      // EXAMPLE 5: E-COMMERCE CART
      // ═══════════════════════════════════════════
      {
        type: "title",
        content: "Example 5: E-Commerce Shopping Cart",
      },
      {
        type: "text",
        content:
  ...
  return (
    <div>
      ...
      },
      {
        ...
        hint: "Hint: useState(2000) for budget, useState([]) for meals. Remaining = budget - total. Style red when remaining < 0.",
        solution: `import { useState } from 'react';
...
export default MealPlanner;`,
      },
      {
        ...
        hint: "Hint: Items have an assignedTo array of person names. Each person's total = sum of (item.price / item.assignedTo.length) for items they're assigned to.",
        solution: `import { useState } from 'react';
...
export default SplitBill;`,
      ...
      // ═══════════════════════════════════════════
      // EXAMPLE 6: TASK DASHBOARD (NESTED STATE)
      // ═══════════════════════════════════════════
      {
        type: "title",
        content: "Example 6: Task Management Dashboard — Nested State",
      },
      {
        type: "text",
        content:
  ...
  return (
    <div>
      ...
      },
      {
        ...
        hint: "Hint: Same nested pattern — classes contain students. Map to find the class, spread to add/filter students.",
        solution: `import { useState } from 'react';
...
export default ClassRoster;`,
      ...
      // ═══════════════════════════════════════════
      // EXAMPLE 7: QUIZ APP (MULTI-STEP STATE)
      // ═══════════════════════════════════════════
      {
        type: "title",
        content: "Example 7: Quiz App — Multi-Step Coordinated State",
      },
      {
        type: "text",
        content:
  ...
  return (
    <div>
      ...
      },
      {
        ...
        hint: "Hint: Use useState for timeLeft and setInterval in a useEffect (or setTimeout in a recursive pattern). Clear the timer when the user answers or time hits 0.",
        solution: `import { useState } from 'react';
...
export default TimedQuiz;`,
        note: "Note: In production, you'd use useEffect for the timer instead of setTimeout in the render body. This simplified version works for understanding state coordination.",
      },
      {
        type: "practiceTask",
        content:
        ...
        hint: "Hint: Add a hintsUsed state. Each question's hint is shown via a boolean (showHint). Revealing deducts from score.",
        solution: `import { useState } from 'react';
...
export default HintQuiz;`,
      ...
      },
      {
        ...
        items: [
          ...
          // "Custom Hooks — Extract reusable state logic (like form validation or API fetching) into custom hooks that can be shared across components.",
        ],
      },
      {
        type: "text",
