...
import { usestateData } from "../data/usestateData";
...
const UsestateGuide = () => {
  ...
  const [checkedTitles, setCheckedTitles] = useState(() => {
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("useStateCheckedTitles");
