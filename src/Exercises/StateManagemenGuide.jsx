...
const StateManagemenGuide = () => {
  const guide = stateManagementData[0];
  ...
  const [checkedTitles, setCheckedTitles] = useState(() => {
    // This runs ONLY once on the very first mount
    const saved = localStorage.getItem("stateManagemenCheckedTitles");
...
export default StateManagemenGuide;
