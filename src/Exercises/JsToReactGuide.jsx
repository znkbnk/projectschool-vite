...
import { jsToReactData } from "../data/jsToReactData";
...
const JsToReactGuide = () => {
  const guide = jsToReactData[0];
  ...
  const saved = localStorage.getItem("JsToReactCheckedTitles");
