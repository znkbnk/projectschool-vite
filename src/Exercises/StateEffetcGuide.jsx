...
import { stateEffectData } from "../data/stateEffectData";
...
const EXCLUDE = ["useState + useEffect", "useState and useEffect"];
...
const StateEffetcGuide = () => {
  const guide = stateEffectData[0];
  ...
  const [checkedTitles, setCheckedTitles] = useState(() => {
    ...
    const saved = localStorage.getItem("useStateUseEffectCheckedTitles");
  ...
  useEffect(() => {
    localStorage.setItem(
      "useStateUseEffectCheckedTitles",
...
export default StateEffetcGuide;
