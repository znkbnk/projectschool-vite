...
import { reactTodoAppData2 } from "../data/reactTodoAppData2";
...
const ReactTodoApp2 = () => {
  const guide = reactTodoAppData2[0];
  ...
  const [checkedTitles, setCheckedTitles] = useState(() => {
    const saved = localStorage.getItem("reactTodoApp2CheckedTitles");
