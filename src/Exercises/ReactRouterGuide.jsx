...
import { reactRouterData } from "../data/reactRouterData";
...
const ReactRouterGuide = () => {
  const guide = reactRouterData[0]; // Use the single guide
  ...
  const [checkedTitles, setCheckedTitles] = useState(() => {
    ...
    try {
      const saved = localStorage.getItem("reactRouterCheckedTitles");
