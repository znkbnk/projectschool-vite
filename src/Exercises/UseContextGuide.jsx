...
import { useContextData } from "../data/useContextData";
...
const UseContextGuide = () => {
  const guide = useContextData[0];
  ...
  const [checkedTitles, setCheckedTitles] = useState(() => {
    const saved = localStorage.getItem("UseContextCheckedTitles");
