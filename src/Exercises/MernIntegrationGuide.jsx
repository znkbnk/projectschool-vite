...
import { mernIntegrationData } from "../data/mernIntegrationData";
...
const MernIntegrationGuide = () => {
  const guide = mernIntegrationData[0];
  ...
  const [checkedTitles, setCheckedTitles] = useState(() => {
    ...
    try {
      const saved = localStorage.getItem("mernIntegrationCheckedTitles");
      return saved ? JSON.parse(saved) : {};
    } catch (error) {
      console.error("Error loading checked titles:", error);
      return {};
    }
  });
...
export default MernIntegrationGuide;
