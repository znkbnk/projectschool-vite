...
import { reactIntroData } from "../data/reactIntroData";
import Navbar from "../components/Navbar";
import Footer from "../components/Footer";
import "../styles/usestateGuide.css";
import SyntaxHighlighter from "react-syntax-highlighter";
import PropTypes from "prop-types";
// import ReactIntroLearningJourneySection from "./ReactIntroLearningJourneySection";
...
const ReactIntro = () => {
  ...
  const [checkedTitles, setCheckedTitles] = useState(() => {
    // Check if window is defined for SSR (Next.js/Vite) safety
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("reactIntroCheckedTitles");
      ...
      <main className='main'>
        <div className='guide'>
          <article>
            ...
            {/* Features Grid */}
            {/* <ReactIntroLearningJourneySection /> */}
            {showBackToTop && (
              <button
