...
export default function TodoItem({ todo, index, onToggle, onDelete, onEdit, onMoveUp, onMoveDown }) {
    ...
    >
      ...
      {todo.category && (
        <span
          style={{
            fontSize: "0.7rem",
            background: categoryColors[todo.category],
            color: "white",
            padding: "2px 8px",
            borderRadius: "10px",
            marginRight: "8px",
...
`];export{e as default};
//# sourceMappingURL=reorder-up-down-D8MNxhxr.js.map